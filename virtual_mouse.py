...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image,(finger_tip_x, finger_tip_y),(thumb_tip_x, thumb_tip_y),(250,0,0),2)
		...
		# print("Disancia:", distance)

		print("Tamaño de la antalla d la computadora: ", screen_width, screen_height, "Tamaño de la ventana del output: ", width, height)
		print("Posicion del mouse", mouse.position, "Posicion del centro de la linea de las puntas: ", center_x, center_y)
